...
class single_scale_gnn(nn.Module):
    def __init__(self, configs):
        ...
        self.tk=configs.tk
        self.scale_number=configs.scale_number + 16
...
class Model(nn.Module):
    ...
    def forward(self,x, x_mark_enc, x_dec, x_mark_dec, mask=None):
        ...
        g_x = self.enc_embedding(x_raw,x_mark_enc)
        ...
        # pred_x = pred_x.permute(0,2,1)
        # pred_x = (self.weight_time * pred_x.permute(0,2,1) ).permute(0,2,1)
        # print(self.weight_1,self.weight)
